...
class ServicesTest < ApplicationSystemTestCase
  ...
  test "creating a Service" do
    ...
    fill_in "Motorcicleworkshop", with: @service.motorcicleWorkshop
    fill_in "Motorcyclecrane", with: @service.motorcycleCrane
    fill_in "Truckcrane", with: @service.truckCrane
    fill_in "Workshopcar", with: @service.workshopCar
