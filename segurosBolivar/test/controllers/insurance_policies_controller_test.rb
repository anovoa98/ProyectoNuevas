...
class InsurancePoliciesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create insurance_policy" do
    assert_difference('InsurancePolicy.count') do
      post insurance_policies_url, params: { insurance_policy: { basic: @insurance_policy.basic, premium: @insurance_policy.premium, standard: @insurance_policy.standard } }
    end
  ...
  test "should update insurance_policy" do
    patch insurance_policy_url(@insurance_policy), params: { insurance_policy: { basic: @insurance_policy.basic, premium: @insurance_policy.premium, standard: @insurance_policy.standard } }
